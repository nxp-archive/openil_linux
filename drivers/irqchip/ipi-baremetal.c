...
#define CONFIG_SYS_DDR_SDRAM_SLAVE_RESERVE_SIZE (64 * 1024 *1024)
#endif

#define CONFIG_SYS_DDR_SDRAM_SHARE_BASE (CONFIG_SYS_DDR_SDRAM_SLAVE_ADDR + CONFIG_SYS_DDR_SDRAM_SLAVE_SIZE*(CONFIG_MAX_CPUS-1))
...
#else
#define CONFIG_SYS_DDR_SDRAM_SHARE_SIZE ( CONFIG_SYS_DDR_SDRAM_SLAVE_RESERVE_SIZE - CONFIG_SYS_DDR_SDRAM_SHARE_RESERVE_SIZE)
#endif
